...
class DatabaseManager:
    ...
    def get_faiss_index_path(document_name: str) -> str:
        ...
        return f"document_embeddings_{document_name}.faiss"
    ...
    def list_documents():
        ...
        faiss_files = glob.glob("document_embeddings_*.faiss")
        if not faiss_files:
        ...
        for faiss_file in faiss_files:
            doc_name = faiss_file.replace("document_embeddings_", "").replace(".faiss", "")
